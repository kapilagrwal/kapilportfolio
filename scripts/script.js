...
$(document).ready(function() {
    ...
    $('.section.intro .option').click(function() {
        ...
        $('.section.work .image').removeClass('is--visible');
        $('.section.work .video-container-wrapper').removeClass('is--visible'); // Hide videos when switching sections
    });
    
    $('.section.intro .option.graphic-design').click(function() {
        $('.section.intro .option.graphic-design').addClass('is--active');
        $('.section.intro .text.graphic-design').addClass('is--visible');
        $('.section.work .hero-image .image.image1').addClass('is--visible');
    });
    
    $('.section.intro .option.video-edits').click(function() {
        $('.section.intro .option.video-edits').addClass('is--active');
        $('.section.intro .text.video-edits').addClass('is--visible');
        $('.section.work .video-container-wrapper').addClass('is--visible'); // Show videos only in Video Edits
        $('.section.work .hero-image .image.imagedum').addClass('is--visible');
    });
    
    $('.section.intro .option.3d-designs').click(function() {
        $('.section.intro .option.3d-designs').addClass('is--active');
        $('.section.intro .text.3d-designs').addClass('is--visible');
    ...
    //     $('.section.intro .option.video-edits').addClass('is--active');
    //     $('.section.intro .text.video-edits').addClass('is--visible');
    //     $('.section.work .video-container-wrapper').addClass('is--visible');
    // });
    // $('.section.intro .option.3d-designs').click(function() {
    //     $('.section.intro .option.3d-designs').addClass('is--active');
    //     $('.section.intro .text.3d-designs').addClass('is--visible');
